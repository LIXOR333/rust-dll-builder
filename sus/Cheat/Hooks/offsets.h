...
namespace O {
	...
	namespace PlayerInventory {
		...
		constexpr auto Main = 0x30;        // Обновлено из IL2CPП дампа
		constexpr auto Wear = 0x38;        // Обновлено из IL2CPP дампа
	};

	namespace Matrix {
		constexpr auto ViewMatrix = 0x194;    // Обновлено из IL2CPP дампа
		constexpr auto ProjectionMatrix = 0x38; // Обновлено из IL2CPP дампа
	};
