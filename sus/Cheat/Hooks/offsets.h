...
// Определение базовых типов и структур
struct Vector3 {
    float x, y, z;
...
namespace O {
    ...
    struct ItemData {
        ...
        static constexpr auto uid = 0x28;
    };
    ...
    struct ItemDefinition {
        static constexpr auto displayName = 0x28;
        static constexpr auto shortname = 0x30;
        static constexpr auto description = 0x38;
    };

    struct AttackEntity {
        static constexpr auto repeatDelay = 0x2B8;
        static constexpr auto deployDelay = 0x2C0;
        static constexpr auto timeSinceDeploy = 0x2C8;
        static constexpr auto nextAttackTime = 0x2D0;
    };

    // Определение пространства имен CO для исправления ошибок
    namespace CO {
        static constexpr auto CheckCapsule = 0x3177A50;
        static constexpr auto LineOfSightCheck = 0x3177A60;
        static constexpr auto IsDown = 0x3177A70;
        static constexpr auto WasJustPressed = 0x3177A80;
    }
